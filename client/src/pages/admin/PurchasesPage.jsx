// Admin single-issue purchases — list of all purchase-type payments
import { useEffect, useState } from "react";
import { motion } from "framer-motion";
import { adminGetAllPaymentsApi } from "../../api/payment.api.js";
import PurchaseTable from "../../components/admin/PurchaseTable.jsx";
  ...
  return (
    <div>
      ...
      {loading && payments.length === 0 ? (
        ...
        <>
          <PurchaseTable payments={payments} />
          <Pagination
